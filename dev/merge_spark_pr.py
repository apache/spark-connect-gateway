...
#
# This utility assumes you already have a local Spark Connect Gateway git folder
# and that you have added remotes corresponding to both (i) the github apache
...
# Location of your Spark Connect Gateway git development area
...
GITHUB_BASE = "https://github.com/apache/spark-connect-gateway/pull"
GITHUB_API_BASE = "https://api.github.com/repos/apache/spark-connect-gateway"
...
def resolve_jira_issue(merge_branches, comment, default_jira_id=""):
    ...
    # Consider only connect-gateway-x.y.z, unreleased, unarchived versions
    versions = [
        x
        for x in versions
        if not x.raw["released"]
        and not x.raw["archived"]
        and re.match(r"connect-gateway-\d+\.\d+\.\d+", x.name)
    ]
